...
The board is populated with an 8 MHz high-speed external oscillator and a
32.768 kHz low-speed external crystal. The current Zephyr board port
configures the PLL from the 8 MHz HSE as follows:

- PLL: div-m=8, mul-n=336, div-p=2, div-q=7 → SYSCLK = 168 MHz
- AHB prescaler = 1 (168 MHz)
- APB1 prescaler = 4 (42 MHz)
- APB2 prescaler = 2 (84 MHz)
- RTC clocked from LSI (32.768 kHz)
